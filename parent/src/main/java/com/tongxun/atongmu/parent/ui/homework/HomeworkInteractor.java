...
import com.tongxun.atongmu.parent.model.HomeworkNofinishCallBack;
...
public class HomeworkInteractor implements IHomeworkNoFinishContract.Interactor {
    ...
    @Override
    public void getNoFinishHomework(final onFinishListener listener) {
        String url= Constants.restGetStudentJob;
        OkHttpUtils.postString()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        Gson gson=new Gson();
                        HomeworkNofinishCallBack callBack= null;
                        try {
                            callBack = gson.fromJson(response,HomeworkNofinishCallBack.class);
                        } catch (JsonSyntaxException e) {
                            e.printStackTrace();
                        }
                        if(callBack!=null){
                            if(callBack.getStatus().equals("success")){
                                listener.onNoFinishSuccess(callBack.getDatas());
                            }else {
