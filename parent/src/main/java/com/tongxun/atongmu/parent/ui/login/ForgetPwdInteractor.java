...
public class ForgetPwdInteractor implements IForgetPwdContract.interactor {
        ...
        OkHttpUtils.postString()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        linstener.onSendError(ParentApplication.getContext().getString(R.string.code_send_error));
                    }
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (smsModel.getStatus().equals("success")) {
                            ...
                            linstener.onSendError(smsModel.getMessage());
                        }
                    }
                });
    }
