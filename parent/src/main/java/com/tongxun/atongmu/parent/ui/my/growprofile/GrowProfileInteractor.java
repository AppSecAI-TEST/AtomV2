...
import com.tongxun.atongmu.parent.model.GrowProfileCallBack;
...
public class GrowProfileInteractor implements IGrowProfileContract.Interactor {
    ...
    @Override
    public void getGrowProfileList(final onFinishListener listener) {
        String url= Constants.getTermPaper;
        OkHttpUtils.postString()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        Gson gson=new Gson();
                        GrowProfileCallBack callBack= null;
                        try {
                            callBack = gson.fromJson(response,GrowProfileCallBack.class);
