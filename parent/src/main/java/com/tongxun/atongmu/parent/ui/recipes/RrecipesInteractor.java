...
import com.tongxun.atongmu.parent.model.RecipesCallBack;
...
public class RrecipesInteractor implements IRecipesContract.Interactor {
     ...
     */
    @Override
    public void getRecipes(String date, final onFinishListener listener) {
        String url= Constants.restGetKindergartenReceipt;
        OkHttpUtils.postString()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        Gson gson=new Gson();
                        RecipesCallBack callBack= null;
                        try {
                            callBack = gson.fromJson(response,RecipesCallBack.class);
